...
@property (nonatomic, assign) UIImageOrientation orginImageOrientation;
...
- (id)initWithImage:(UIImage *)originalImage cropFrame:(CGRect)cropFrame limitScaleRatio:(NSInteger)limitRatio {
    ...
    if (self) {
        ...
        self.orginImageOrientation = originalImage.imageOrientation;
    }
    return self;
}
...
//    NSLog(@"orginImageOrietation = %d", self.originalImage.imageOrientation);
    UIImage *newImage = [self.originalImage fixOrientationWithOrientation:self.orginImageOrientation];//根据原来图片的朝向 修改图片朝向
//    NSLog(@"newImage.imageOrietation = %d",newImage.imageOrientation);
