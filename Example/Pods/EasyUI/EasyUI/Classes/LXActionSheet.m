...
- (UILabel *)creatTitleLabelWith:(NSString *)title
{
    ...
    titlelabel.center=CGPointMake(self.backGroundView.center.x, titlelabel.center.y);
    return titlelabel;
}
...
- (UIButton *)creatDestructiveButtonWith:(NSString *)destructiveButtonTitle
{
    ...
    destructiveButton.center=CGPointMake(self.backGroundView.center.x, destructiveButton.center.y);
...
- (UIButton *)creatOtherButtonWith:(NSString *)otherButtonTitle withPostion:(NSInteger )postionIndex
{
    ...
    otherButton.center=CGPointMake(self.backGroundView.center.x, otherButton.center.y);
    return otherButton;
}
...
- (UIButton *)creatCancelButtonWith:(NSString *)cancelButtonTitle
{
    ...
    cancelButton.center=CGPointMake(self.backGroundView.center.x, cancelButton.center.y);
