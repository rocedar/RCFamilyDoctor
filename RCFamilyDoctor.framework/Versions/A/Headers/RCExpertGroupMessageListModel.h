//
//  RCExpertGroupMessageListModel.h
//  AFNetworking
//
...
@interface RCExpertGroupMessageListModel : NSObject
/** 0,已结束咨询；1，正在咨询 */
...
@interface RCSicksModel : NSObject
/** 病人id */
...
@interface RCLaboratoryExpertModel : NSObject
/** 擅长 */
...
@interface RCSubjectLectureModel : NSObject
/** 视频主题 */
...
@interface RCExpertIntroduceModel : NSObject
/** 医生id */
@property (assign, nonatomic) int doctor_id;
/** 擅长 */
@property (copy, nonatomic) NSString *skilled;
